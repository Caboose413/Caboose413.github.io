...
## Inventory System
Flexible Inventory system which supports infinitly stacking containers.
the system is built on Generic data which can be easily specialized to create all sorts of interaction
